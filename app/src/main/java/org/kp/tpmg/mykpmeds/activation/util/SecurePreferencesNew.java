...
public class SecurePreferencesNew {

    private static final String TRANSFORMATION = "AES/OFB/NoPadding";
    private static final String KEY_TRANSFORMATION = "AES/OFB/NoPadding";
    ...
    public SecurePreferencesNew(Context context, String preferenceName,
    ...
    private static synchronized byte[] convert(Cipher cipher, byte[] byteArray) {
        try {
